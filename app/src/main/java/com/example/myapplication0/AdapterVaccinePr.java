...
public class AdapterVaccinePr extends RecyclerView.Adapter<AdapterVaccinePr.MyVh> {
Context context;
ArrayList<VaccineInfo> arrayList;
DatabaseReference databaseReference;


    public AdapterVaccinePr(Context context, ArrayList<VaccineInfo> arrayList) {
